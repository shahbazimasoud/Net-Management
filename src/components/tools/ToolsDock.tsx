...
export const ToolsDock: React.FC<ToolsDockProps> = ({
  ...
  return (
    <div
      ...
      } z-40 flex items-center gap-1.5 sm:gap-2 select-none max-w-[calc(100vw-24px)] sm:max-w-[calc(100vw-36px)] md:max-w-[calc(100vw-48px)] transition-all duration-300`}
      dir={isRtl ? 'rtl' : 'ltr'}
    >
        ...
        <div className="relative shrink-0">
          ...
          {isMenuOpen && (
            <div
              ...
              } w-72 sm:w-80 p-2.5 rounded-2xl border shadow-2xl backdrop-blur-2xl z-50 animate-in fade-in zoom-in-95 ${
                isLightMode
